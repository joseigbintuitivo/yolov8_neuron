...
| [Neuron](https://awsdocs-neuron.readthedocs-hosted.com)            | `neuron`          | `yolov8n-seg.neuron`          | ✅        | `imgsz`, `half`, `dynamic`, `ccargs`                                           |
| [Neuronx](https://awsdocs-neuron.readthedocs-hosted.com)           | `neuronx`         | `yolov8n-seg.neuronx`         | ✅        | `imgsz`, `half`, `fp8`, `dynamic`, `ccargs`                                           |
